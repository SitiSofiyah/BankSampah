...
public class sampahMenunggu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new AdapterTransaksiTR(recyclerListView,this, "PKtunggu");
        viewTrans();
    ...
    public void viewTrans(){
        ...
        final Query query = transDB.child("transaksiTR").orderByChild("status").equalTo("terima");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.akun:
                Intent intent = new Intent(sampahMenunggu.this, db_ReadAkun.class);
                startActivity(intent);
                return true;

            case R.id.help:
                Intent intentt = new Intent(sampahMenunggu.this, Bantuan.class);
            ...
            case R.id.out:
                ...
                Intent intents = new Intent(sampahMenunggu.this, login.class);
