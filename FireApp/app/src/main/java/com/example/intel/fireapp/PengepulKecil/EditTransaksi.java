...
public class EditTransaksi extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.akun:
                Intent intent = new Intent(EditTransaksi.this, db_ReadAkun.class);
                startActivity(intent);
                return true;

            case R.id.help:
                Intent intentt = new Intent(EditTransaksi.this, Bantuan.class);
            ...
            case R.id.out:
                ...
                Intent intents = new Intent(EditTransaksi.this, login.class);
